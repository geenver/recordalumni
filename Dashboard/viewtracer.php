<?php
														...
														$sql = "SELECT *  FROM tracer WHERE id='$id'";
								...
								<div class="profile-header">
									...
									<?php
														...
														while($row = $result->fetch_assoc()) {
															...
															echo '<img src="upload_pics/'.$row['image'].'?>" width="100" height="100" class="img-circle" alt="Avatar">';
									...
									<div class="profile-stat">
										<div class="row">
											<div class="col-md-4 stat-item">
												 ID Number: <span><?php echo $id;?></span>
											</div>
											<div class="col-md-4 stat-item">
												 <span></span>
											</div>
