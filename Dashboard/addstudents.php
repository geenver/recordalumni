...
<?php
                      ...
                      if(isset($_REQUEST['submit']))
                      {
                        ...
                        if(!isset($errMSG))
                        {
                          $stmt = $DB_con->prepare('INSERT INTO students(id,fullname,year,course,image) 
                                                    VALUES(:uid,:ufullname,:uyear,:ucourse,:uimage)');
                          ...
                          if($stmt->execute())
                          {
                            $successMSG = "SUCCESSFULY REGISTERED STUDENTS";
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                         ...
                         <?php if (isset($errMSG)) {echo "<div class=\"alert alert-danger\"><strong>Note: </strong>" .$errMSG. "</div>"; }?>
                             ...
                             <form class="form-horizontal" action="addstudents.php" method="post" enctype="multipart/form-data">
                            <!-- .row -->
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <div class="white-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="id" placeholder="Student ID" class="form-control form-control-line"> 
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="example-email" class="col-md-12">Full Name</label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="fullname" placeholder="(Last Name,First Name,Middle Initial)" class="form-control form-control-line" id="example-email"> 
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-12">Year Graduated</label>
                                                    <div class="col-md-12">
                                                        <input type="tect" name="year" class="form-control form-control-line"> 
                                                    </div>
                                                </div>
                                                <div class="form-group">
