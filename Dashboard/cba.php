			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="cba.php" class="active"><i class="lnr lnr-chart-bars"></i> <span>College of Business Administration</span></a></li>
		                    ...
		                    <div class="col-lg-12 col-md-12">
		                        <div class="card">
		                            <div class="card-body">
		                                <div class="d-flex">
		                                    <div>
		                                        <h3 class="card-title m-b-5"><span class="lstick"></span>Registered Alumni Members of Business Administration</h3>
		                                ...
		                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
		                                        ...
		                                        <tbody>
														...
														$sql = "SELECT *  FROM tracer WHERE college='College of Business Administration'";
