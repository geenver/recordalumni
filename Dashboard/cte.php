			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="cte.php" class="active"><i class="lnr lnr-chart-bars"></i> <span>College of Teachers Education</span></a></li>
		                    ...
		                    <div class="col-lg-12 col-md-12">
		                        <div class="card">
		                            <div class="card-body">
		                                <div class="d-flex">
		                                    <div>
		                                        <h3 class="card-title m-b-5"><span class="lstick"></span>Registered Alumni Members of College of Teachers Education</h3>
		                                ...
		                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
		                                        ...
		                                        <tbody>
														...
														$sql = "SELECT *  FROM tracer WHERE college='College of Teachers Education'";
