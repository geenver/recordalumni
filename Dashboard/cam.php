	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="students.php" ><i class="lnr lnr-home"></i> <span>Alumni Members</span></a></li>
						<li><a href="tracer.php" ><i class="lnr lnr-chart-bars"></i> <span>Alumni Tracer</span></a></li>

						<li><a href="cam.php" class="active"><i class="lnr lnr-chart-bars"></i> <span>College of Allied Medicine</span></a></li>
						...
						<li><a href="job_tracer.php" class=""><i class="lnr lnr-chart-bars"></i> <span>Job Tracer</span></a></li>
		                    ...
		                    <div class="col-lg-12 col-md-12">
		                        <div class="card">
		                            <div class="card-body">
		                                <div class="d-flex">
		                                    <div>
		                                        <h3 class="card-title m-b-5"><span class="lstick"></span>Registered Alumni Members of College of Alled Medicine</h3>
		                                ...
		                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
		                                        ...
		                                        <tbody>
														...
														$sql = "SELECT *  FROM tracer WHERE college='College of Allied Medicine'";
														...
														while($row = $result->fetch_assoc()) {
															...
															echo '<td>';
															echo '<a href="viewtracer.php?id='.$row['id'].'" class="btn btn-primary">View Tracer Information</a>';
															echo '<a href="edittracer.php?id='.$row['id'].'" class="btn btn-warning">Update Tracer</a>';
															echo '<a href="deletetracer.php?id='.$row['id'].'" class="btn btn-danger">Delete</a>';
															echo '</td>';
															echo '</tr>';
		                                    ...
		                                    <a class="btn btn-success btn-md" href="addtracer.php">Add to Tracer</a>
