			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="job_tracer.php" class="active"><i class="lnr lnr-chart-bars"></i> <span>Job Tracer</span></a></li>
		                    ...
		                    <div class="col-lg-12 col-md-12">
		                        <div class="card">
		                            <div class="card-body">
		                                <div class="d-flex">
		                                    <div>
		                                        <h3 class="card-title m-b-5"><span class="lstick"></span>Job Tracer</h3>
		                                ...
		                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
		                                     ...
		                                     <br/>
		                                    <a class="btn btn-success btn-md" href="print_report.php">Print Report</a>
