		                                ...
		                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
		                                        ...
		                                        <tbody>
														...
														while($row = $result->fetch_assoc()) {
															...
															echo '<a href="viewstudents.php?id='.$row['id'].'" class="btn btn-primary">View Information</a>';
															echo '<a href="editstudents.php?id='.$row['id'].'" class="btn btn-warning">Update Information</a>';
															echo '<a href="deletestudents.php?id='.$row['id'].'" class="btn btn-danger">Delete</a>';
															echo '</td>';
															echo '</tr>';
		                                    ...
		                                    <a class="btn btn-success btn-md" href="addstudents.php">Add Alumni</a>
